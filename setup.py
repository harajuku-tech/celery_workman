...
# -*- coding: utf-8 -*-
#
#  This file is part of celery_workman
#
...
from celery_workman import get_version

NAME='celery_workman'
DESCRIPTION=''
PACKAGES=['celery_workman',]
...
if __name__=='__main__':
    setup(
        ...
        url = 'https://github.com/harajuku-tech/celery_workman',
        description = 'celery_workman is a _______________________.',
        long_description = read('README.rst'),
        download_url = 'https://github.com/harajuku-tech/celery_workman',
        platforms=['any'],
        classifiers = [
